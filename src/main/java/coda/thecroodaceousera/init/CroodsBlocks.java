...
import coda.thecroodaceousera.block.CroodaceousShrubBlock;
...
public class CroodsBlocks {
    ...
    // Croodaceous Sand
    public static final RegistryObject<Block> CROODACEOUS_SAND = register("croodaceous_sand", () -> new SandBlock(0xe7ba8a, AbstractBlock.Properties.of(Material.SAND).strength(0.5f).sound(SoundType.SAND)));
    ...
    // Hoodoo Shale
    public static final RegistryObject<Block> HOODOO_SHALE = register("hoodoo_shale", () -> new Block(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_BROWN).strength(1.5f, 6.0f).requiresCorrectToolForDrops()));
    ...
    // Other
    public static final RegistryObject<Block> CROODACEOUS_SHRUB = register("croodaceous_shrub", () -> new CroodaceousShrubBlock(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_BROWN).noCollission().sound(SoundType.GRASS).strength(0.0f)));
